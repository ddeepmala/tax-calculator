...
function renderBreakdownTable(old_br, new_br) {
    ...
    const rows = [
        ...
        { label: "Less: Investment Deductions (PPF, EPF, ELSS etc)", oldVal: old_br.deductions.sec_80c, newVal: null, isDisallowed: true },
        { label: "Less: Additional NPS Contribution", oldVal: old_br.deductions.sec_80ccd_1b, newVal: null, isDisallowed: true },
        { label: "Less: Health Insurance Premium", oldVal: old_br.deductions.sec_80d, newVal: null, isDisallowed: true },
        { label: "Less: Savings/Deposit Interest Deduction", oldVal: old_br.deductions.interest_deduction, newVal: null, isDisallowed: true },
        { label: "Less: Employer NPS Contribution", oldVal: old_br.deductions.sec_80ccd_2_employer, newVal: new_br.deductions.sec_80ccd_2_employer },
        { label: "Less: Other deductions (education loan, donations, disability etc.)", oldVal: (old_br.deductions.sec_80e + old_br.deductions.sec_80g + old_br.deductions.sec_80ee + old_br.deductions.sec_80eea + old_br.deductions.sec_80u + old_br.deductions.sec_80dd), newVal: new_br.deductions.sec_80cch_agniveer },
        ...
        { label: "Less: Tax Rebate (K)", oldVal: old_br.sec_87a_rebate, newVal: new_br.sec_87a_rebate },
        { label: "Less: Marginal Relief (L)", oldVal: 0, newVal: new_br.sec_87a_marginal_relief },
...
function renderCharts(res) {
    ...
    const dedLabelMap = [
        ...
        { label: 'PF/ELSS/PPF', val: old_br.deductions.sec_80c },
        { label: 'Additional NPS', val: old_br.deductions.sec_80ccd_1b },
